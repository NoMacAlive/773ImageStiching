...
def main():
    ...
    #TODO:precomputeMatchingDescriptor right image and right corners
    ...
    putativeMatches = alignment.match(descriptor_L,descriptor_R,newTuples_L,newTuples_R)
    ...
    for tuple in putativeMatches:
        pointA = (tuple[0][1], tuple[0][0]) #(x,y)
        pointB = (tuple[1][1], tuple[1][0])
